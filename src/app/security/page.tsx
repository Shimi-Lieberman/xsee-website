  ...
  return (
    <>
      ...
      <main style={{ paddingTop: 64 }}>
        ...
        <section className="section sec-light" id="aws-access">
          <div className="container">
            <div className="section-head reveal" style={{ textAlign: "left", maxWidth: "100%" }}>
              ...
              <p style={{ fontWeight: 600, marginBottom: 12 }}>What this means:</p>
              <ul className="sec-check-list sec-check-green">
                <li>XSEE can NEVER create, modify, or delete any resource</li>
                <li>XSEE can NEVER change IAM policies or permissions</li>
                <li>XSEE can NEVER access your data directly</li>
                <li>You can revoke access instantly by deleting the IAM role</li>
                <li>We never store your AWS credentials — only temporary STS tokens used during the scan session</li>
              </ul>
        ...
        <section className="section sec-navy" id="data-handling">
          <div className="container">
            <div className="section-head reveal" style={{ textAlign: "left", maxWidth: "100%" }}>
              ...
              <div className="sec-info-box" style={{ marginTop: 32, maxWidth: 600 }}>
                ...
                <ul style={{ margin: 0, padding: 0, listStyle: "none", fontSize: 14, lineHeight: 1.9 }}>
        ...
        <section className="section sec-light" id="platform-security">
          <div className="container">
            <div className="section-head reveal" style={{ textAlign: "left", maxWidth: "100%" }}>
              <h2 className="display-md" style={{ marginBottom: 32 }}>
              ...
              <ul className="sec-platform-list">
                <li><strong>Authentication:</strong> JWT tokens in httpOnly cookies (not localStorage — not accessible via JavaScript)</li>
                <li><strong>Passwords:</strong> bcrypt hashed, never stored in plaintext</li>
                <li><strong>Sessions:</strong> Expire after 24 hours, refresh tokens expire after 30 days</li>
                <li><strong>RBAC:</strong> Admin / member / viewer role separation</li>
                <li><strong>Org isolation:</strong> Every query scoped to your organization, no cross-org data access possible</li>
                <li><strong>API:</strong> All endpoints require authentication except public free scan submission</li>
                <li><strong>Infrastructure:</strong> AWS EC2 + RDS, us-east-1, isolated VPC, security groups locked to app server</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="section sec-navy" id="vulnerability">
          <div className="container">
            <div className="section-head reveal" style={{ textAlign: "left", maxWidth: "100%" }}>
              <h2 className="display-md" style={{ marginBottom: 20 }}>
        ...
        <section className="section sec-light" id="compliance">
          <div className="container">
            <div className="section-head reveal" style={{ textAlign: "left", maxWidth: "100%" }}>
              <h2 className="display-md" style={{ marginBottom: 32 }}>
                Where we&apos;re headed.
              ...
              <div className="sec-compliance-grid">
                ...
                <div className="sec-compliance-col">
                  ...
                  <ul className="sec-compliance-list">
        ...
        <section className="section sec-navy" id="questions">
          <div className="container">

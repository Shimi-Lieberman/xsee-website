...
export async function POST(request: Request) {
  ...
  try {
    body = await readJsonBody(request, MAX_CHAT_JSON_BYTES);
  } catch (err) {
  ...
  // Only accept the two roles the API understands, and require string content
  // rather than coercing arbitrary JSON into a prompt.

        ...
        <div className="xsee-hero-layout">
          ...
          <div id="path" className="xsee-instrument hero-rise overflow-hidden" style={{ animationDelay: "0.2s" }}>
            <div className="xsee-instrument-bar">
              <div className="flex min-w-0 items-center gap-3"><span className="xsee-status-dot" /><span className="v2-mono text-[10px] tracking-[0.14em]">VERIFIED ATTACK PATH</span><span className="v2-mono hidden text-[10px] text-[var(--v2-ink3)] sm:block">ACME-PROD / US-EAST-1</span></div>
              <div className="v2-mono hidden text-[10px] text-[var(--v2-ink3)] md:block">EVIDENCE REF. 7F2A</div>
            </div>
            <div className="xsee-live-summary" aria-label="Verified path summary">
              <span><i className="is-threat" />EXPOSURE IDENTIFIED</span>
            ...
            <div className="xsee-instrument-foot">
              ...
              <Link href="/#proof" className="v2-mono inline-flex items-center gap-1.5 text-[9px] text-[var(--v2-ink2)] hover:text-[var(--v2-ink)]">OPEN PROOF <ArrowUpRight className="h-3.5 w-3.5" aria-hidden /></Link>
            </div>
          </div>
        </div>
      </div>

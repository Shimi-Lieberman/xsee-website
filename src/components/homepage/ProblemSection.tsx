    ...
    <section id="problem" className="hp-section" aria-labelledby="problem-title">
      <div className="hp-container grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        <div className="lg:col-span-6">
          <p className="hp-eyebrow mb-6">The core problem</p>
          <h2
            id="problem-title"
            className="font-semibold text-[var(--hp-ink)]"
            style={{ fontSize: "clamp(34px, 4.4vw, 56px)", lineHeight: 1.08, letterSpacing: "-0.03em" }}
          >
            Every cloud security tool tells you what&apos;s&nbsp;wrong.
            <span className="text-[var(--hp-ink3)]"> None of them prove it can actually be exploited.</span>
          </h2>
        </div>

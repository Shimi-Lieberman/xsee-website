      ...
      <div className="container">
        ...
        <div className="cta-two-options reveal-on-scroll">
          <div className="cta-option cta-option-free">
            ...
            <h3 className="cta-option-title">Free Breach Proof Report</h3>
          ...
          <div className="cta-option cta-option-platform">
            ...
            <p className="cta-option-body">
              14-day full access to all 6 engines. See your Detection Coverage Score. Generate evidence packages. Start at $1,200/month after trial.
            </p>
            <Link

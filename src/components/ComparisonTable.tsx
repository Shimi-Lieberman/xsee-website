export const COMPARISON_ROWS = [
  ...
  { cap: "Nightly CVE threat hunting", xsee: "Automated nightly hunt", wiz: null, prisma: null, xseeChk: true, wizChk: false, prismaChk: false },
  { cap: "Weekly board report auto-generated", xsee: "Executive-ready weekly report", wiz: null, prisma: null, xseeChk: true, wizChk: false, prismaChk: false },
  { cap: "Autonomous investigation agent", xsee: "Continuous investigation agent", wiz: null, prisma: null, xseeChk: true, wizChk: false, prismaChk: false },
  ...
  return (
    <section className="section sec-navy reveal" id="compare">
      <div className="container">
        ...
        <div className="cmp-wrap compare-grid reveal-on-scroll">

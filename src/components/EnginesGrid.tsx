  ...
  },
  {
    ...
    icon: (
      <svg width={22} height={22} viewBox="0 0 22 22" fill="none" className="engine-icon-svg" style={{ transition: "color 0.25s" }}>
        ...
        <line x1={7} y1={10} x2={15} y2={10} stroke="currentColor" strokeWidth={1.2} opacity={0.7} />
        <polyline points="7,13.5 9.5,16 15,11" stroke="#10B981" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  },
];
